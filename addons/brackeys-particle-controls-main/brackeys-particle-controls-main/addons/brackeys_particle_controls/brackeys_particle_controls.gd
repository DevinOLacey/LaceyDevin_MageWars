...
func _enter_tree() -> void:
	dock = preload("res://addons/brackeys-particle-controls-main/brackeys-particle-controls-main/addons/brackeys_particle_controls/BrackeysParticleControlsUI.tscn").instantiate()
